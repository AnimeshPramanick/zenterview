      ...
      {feedbackList &&
        feedbackList?.map((item, index) => (
          <Collapsible key={index} className="my-7">
            <CollapsibleTrigger className="bg-secondary rounded-lg p-3 my-2 text-left border w-full flex justify-between gap-5">
              {item.question}
              <ChevronsUpDown />
            </CollapsibleTrigger>
            <CollapsibleContent>
              <div className="flex flex-col gap-2">
                <h2 className="text-red-500 p-3 border rounded-lg">
